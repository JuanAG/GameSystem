    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
          ...
          $('#submit').click(function(e){
            ...
            var parameters = {
                "name": name, "lastName": lastName, "address": address, "cp": cp, "dni": dni, "mail": mail, "login": login, "pass": password, "remenberMe": remenberMe
           };
...
<?php
    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
        ...
        // After all the checks if they are ok we send the insert into the database
        if($res == "<div class=\"formErrors\"><p>".formRegisterThanks."</p><div>"){
